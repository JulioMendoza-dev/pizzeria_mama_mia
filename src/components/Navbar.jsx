...
function Navbar() {
  ...
  <div className="container-fluid ">
    <a className="navbar-brand text-white" href="#"><h4>Mama - mia !</h4></a>
    ...
    <div className="collapse navbar-collapse d-flex justify-content-between " id="navbarNav">
      <ul className="navbar-nav">
        ...
        <button class="btn btn-outline-warning m-5 position-absolute bottom-2 end-0" type="button"><h5> Total = {total}</h5></button>
    </div>
  </div>
</nav>
   </>
